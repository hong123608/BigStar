...
import com.caozan.bigstar.fragment.LoadingFragment;
import com.caozan.bigstar.utils.JsonUtils;
...
public class RequestManager {
	public static RequestQueue mRequestQueue = Volley.newRequestQueue(MyApplication
			.getContext());
